...
function setup() {
  ...
  bubbleImg1 = loadImage("mini-games/assets/img/Bubble1.png");
  bubbleImg2 = loadImage("mini-games/assets/img/Bubble2.png");
  bubbleGif = loadImage("mini-games/assets/img/Bubble.gif");
  bubbleTitleGif = loadImage("mini-games/assets/img/BubbleTitle.gif");
  pressStartGif = loadImage("mini-games/assets/img/PressStart.gif");
